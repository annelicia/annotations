    ...
    return (
        <div className="flex items-center gap-5 flex-wrap mb-5">
            <div className="border-solid border-black-700 border-2 p-3 flex gap-5 flex-row items-center">
                ...
                <button data-ui={selectedTool === ToolsType.RESIZE ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/resize.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.RESIZE)} /></button>
                <button data-ui={selectedTool === ToolsType.MOVE ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/move.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.MOVE)} /></button>
                <button data-ui={selectedTool === ToolsType.SELECT ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/select.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.SELECT)} /></button>
            </div>
            <div className="border-solid border-black-700 border-2 p-3 flex gap-5 flex-row items-center">
                <button data-ui={selectedTool === ToolsType.TEXT ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/text.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.TEXT)} /></button>
                <button data-ui={selectedTool === ToolsType.CIRCLE_FRAME ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/circle-frame.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.CIRCLE_FRAME)} /></button>
                <button data-ui={selectedTool === ToolsType.CIRCLE ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/circle.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.CIRCLE)} /></button>
                <button data-ui={selectedTool === ToolsType.RECT_FRAME ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/rectangle-frame.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.RECT_FRAME)} /></button>
                <button data-ui={selectedTool === ToolsType.RECT ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/rectangle.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.RECT)} /></button>
                <button data-ui={selectedTool === ToolsType.TRIANGLE_FRAME ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/triangle-frame.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.TRIANGLE_FRAME)} /></button>
                <button data-ui={selectedTool === ToolsType.TRIANGLE ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/triangle.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.TRIANGLE)} /></button>
                <button data-ui={selectedTool === ToolsType.LINE ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/line.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.LINE)} /></button>
                <button data-ui={selectedTool === ToolsType.PEN ? "active" : ""} className="w-8 h-8 data-active:bg-slate-300 rounded-lg flex items-center justify-center"><img src="/pen.svg" width="18" height="18" onClick={() => handleChangeTool(ToolsType.PEN)} /></button>
